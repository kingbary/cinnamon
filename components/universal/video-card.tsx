...
export default function VideoCard({ props }: { props: Props }) {
    return (
        <div className='bg-white rounded-4xl flex flex-col gap-2 w-full p-1 overflow-hidden'>
            ...
            <div className='py-6 px-4 flex flex-col gap-3'>
                ...
                <div className="flex">
                    ...
                    <div className='flex gap-4 items-center pl-4'>
                        <div className={`bg-[${props.tag.bgColor}] rounded-md text-sm text-[${props.tag.textColor}] font-medium px-2 py-1`}>
                            {props.tag.text}
                        </div>
                    </div>
                </div>
